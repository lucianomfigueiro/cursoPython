...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:pichorra07@localhost/clinica_pet'
db = SQLAlchemy(app)
...
class Animal(db.Model):
    ...
    def to_json(self):
        return {"id": self.id, "especie":self.especie, "nome": self.nome, "idade": self.idade,
                "peso":self.peso, "raca":self.raca}
